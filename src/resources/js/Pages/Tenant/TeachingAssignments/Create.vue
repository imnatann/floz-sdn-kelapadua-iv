...
const submit = () => {
  form.post('/teaching-assignments', {
    preserveScroll: true,
  });
};
</script>
...
<template>
  ...
  <div class="max-w-3xl mx-auto">
    ...
    <div class="mb-6 flex items-center justify-between">
      <div>
        <h2 class="text-xl font-bold text-slate-800">Tambah Penugasan Baru</h2>
        <p class="text-sm text-slate-500 mt-0.5">Atur jadwal mengajar guru</p>
      </div>
      <Link
