            ...
            <table class="w-full text-sm text-left">
                <thead class="text-xs text-slate-500 uppercase bg-slate-50 border-b border-slate-100">
                    <tr>
                        ...
                        <th class="px-5 py-3 text-right" style="width: 150px">Nilai (Maks: {{ exam.max_score }})</th>
                    ...
                    <tr v-for="(student, index) in students" :key="student.id" class="bg-white border-b border-slate-50 hover:bg-slate-50/50">
                        ...
                        <td class="px-5 py-4">
                            <input 
                                ...
                                :class="form.scores[index].score > exam.max_score ? 'ring-red-300 border-red-300 focus:ring-red-500 text-red-600 bg-red-50' : 'ring-slate-300 border-0'"
                                :max="exam.max_score"
                                min="0"
                                step="0.01"
                                placeholder="0"
