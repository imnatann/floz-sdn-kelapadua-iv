...
<template>
  <div class="space-y-6">
    <div class="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
      <div>
        <h2 class="text-xl font-bold text-slate-800">Absensi Kelas</h2>
        <p class="mt-0.5 text-sm text-slate-400">Pilih kelas untuk mengelola absensi per pertemuan</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Link 
            ...
            :href="route('attendance.show', c.id)"
            class="block group"
        >
