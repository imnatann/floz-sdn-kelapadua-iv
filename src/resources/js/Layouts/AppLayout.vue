...
const navigation = computed(() => {
  ...
  const items = [
    ...
    { type: 'divider', name: 'ANALITIK', show: permissions.manage_analytics },
    { name: 'Analitik', href: '/analytics', icon: 'analytics', show: permissions.manage_analytics },
    { name: 'Laporan', href: '/analytics/reports', icon: 'report', show: permissions.manage_analytics },
