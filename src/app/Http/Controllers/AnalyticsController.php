...
/**
 * Excel export endpoints for attendance + grade recaps.
 *
 * Note: the dashboard + reports UI that previously lived here was removed
 * (user request — pages dianggap noisy). Only the export actions remain,
 * still gated by the 'view-analytics' Gate so the URLs aren't world-readable.
 */
